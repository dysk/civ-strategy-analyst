class GameProjectionsController < ApplicationController
  ...
  def key_moment_groups
    ...
    [
      ...
      [ "Research Rushes", { nil => moments.research_rushes.select { |m| m[:rush] } } ],
      [ "Great People", { "First of a Kind" => moments.great_people_first_of_kind,
                           "Lost in Battle" => moments.great_people_lost } ],
